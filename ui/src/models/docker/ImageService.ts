...
import { ScanReturn, ImagesStateType } from "../../../ui-types";
...
export const ImageService = {
  ...
  async saveScan(imagesList: ImageType[], time: string): Promise<{timeStamp: string}> {
    try {
			const saveList: { timeStamp: string } = await ddClientRequest(
